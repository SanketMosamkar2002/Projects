                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Book ID"></asp:TextBox>
                               ...
                               <asp:LinkButton class="btn btn-primary" ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"><i class="fa-sharp fa-solid fa-circle-check"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-8">
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="row">
                                                     <div class="col-lg-12">
                                                          ...
                                                          Cost -
                                                        <asp:Label ID="Label13" runat="server" Font-Bold="True" Text='<%# Eval("book_cost") %>'></asp:Label>
                                                        &nbsp;| Actual Stock -
                                                        <asp:Label ID="Label14" runat="server" Font-Bold="True" Text='<%# Eval("actual_stock") %>'></asp:Label>
                                                        &nbsp;| Available Stock -
                                                        <asp:Label ID="Label15" runat="server" Font-Bold="True" Text='<%# Eval("current_stock") %>'></asp:Label>
                                                         </div>
                                                    </div>

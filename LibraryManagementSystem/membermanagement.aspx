            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="95px" src="imgs/user.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Member ID"></asp:TextBox>
                               <asp:LinkButton ID="LinkButton1" class="btn btn-primary" runat="server" OnClick="LinkButton1_Click">Go</asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control mr-1" ID="TextBox7" runat="server" placeholder="Account Status" ReadOnly="True"></asp:TextBox>
                               ...
                               <asp:LinkButton class="btn btn-success mr-1" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click"><i class="fa-solid fa-circle-check"></i></asp:LinkButton>
                               ...
                               <asp:LinkButton class="btn btn-danger mr-1" ID="LinkButton4" runat="server" OnClick="LinkButton4_Click"><i class="fa-solid fa-circle-xmark"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                  </div>
